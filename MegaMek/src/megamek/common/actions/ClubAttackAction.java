...
public class ClubAttackAction extends PhysicalAttackAction {
    ...
    public static ToHitData toHit(IGame game, int attackerId,
        ...
        // elevation
        setHitTableFromElevation(target, aimTable, attackerElevation, targetElevation, shield, toHit);
	...
	private static void setHitTableFromElevation(Targetable target, int aimTable, final int attackerElevation,
	...
	private static int calculateBase(Mounted club, int base) {
